...
function ResizableRect(_ref) {
  ...
  var _useState5 = React.useState(focusChange),
    _useState6 = _slicedToArray(_useState5, 2),
    isFocused = _useState6[0],
    _setIsFocused = _useState6[1];
  var topRef = React__default["default"].useRef(top);
  var setTop = function setTop(data) {
    topRef.current = data;
    _setTop(data);
  };
  var leftRef = React__default["default"].useRef(left);
  var setLeft = function setLeft(data) {
    leftRef.current = data;
    _setLeft(data);
  };
  var isFocusedRef = React__default["default"].useRef(isFocused);
  ...
  var _useState9 = React.useState((_initValues$height = initValues === null || initValues === void 0 ? void 0 : initValues.height) !== null && _initValues$height !== void 0 ? _initValues$height : 100),
    _useState10 = _slicedToArray(_useState9, 2),
    height = _useState10[0],
    setHeight = _useState10[1];
  var _useState11 = React.useState(defaultRotateAngle),
    _useState12 = _slicedToArray(_useState11, 2),
    rotateAngle = _useState12[0],
    setRotateAngle = _useState12[1];
  // const [itemId, setItemId] = useState(uuidv4())
  var _useState13 = React.useState(id),
